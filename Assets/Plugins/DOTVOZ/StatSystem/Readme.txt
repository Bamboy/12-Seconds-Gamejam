...
Stat System is a system for stats that can be used from a simple to a complex RPG game that uses JSON as data.<br/>
<br/>
<strong>Features/Scripts</strong><br/>
- <strong>Stat</strong>, Used for storing the Stat data.<br/>
- <strong>StatEffect</strong>, Used for changing Stats at runtime, can be used for easy Powerups and/or Abilities implementation.<br/>
- <strong>StatObject</strong>, A MonoBehaviour derived object that is used for storing its Stats and StatEffect information.<br/>
- <strong>Unit</strong>, A StatObject derived object that has a simple built-in Health/Damage system implemented with Damage Types and Resistances.<br/>
- <strong>JSONLoader</strong>, Used for loading and caching JSON files.<br/>
<br/>
<strong>Warning</strong>: This has no Inspector support. Pure JSON for setting up the Stats and StatEffects' data.<br/>
<strong>Note</strong>: This is using the SimpleJSON plugin created by Bunny83 & oPless.
---
